...
Cinq groupes directement soutenus par le planning : JJB enfants 7–10 ans ; JJB enfants 10–14 ans ; JJB Adolescents et Adultes ; Jiu-Jitsu Traditionnel / Combat enfants 7–10 ans ; Jiu-Jitsu Traditionnel / Combat enfants 10–14 ans. Leurs noms ne créent aucune contrainte d’éligibilité. Aucun groupe ne porte une année.

Un sixième groupe technique de démonstration, **JJB pratiques spécifiques**, rassemble les quatre séances mixtes/No-Gi/libres, avec une description signalant explicitement son caractère provisoire. Le rattachement à JJB conserve la seule activité commune aux quatre libellés sans créer une activité combinée fictive. Il ne tranche pas entre cours simultanés, séance partagée ou appellation commerciale. La préparation physique reste proposée dans activities, sans groupe autonome inventé.

Cette représentation est une **interprétation du modèle, pas un groupe public confirmé**. Les libellés individuels sont conservés dans practice_label ; le lundi ne reçoit pas artificiellement une tranche d’âge. Dans cette V1, un essai rattaché à ce groupe suit techniquement les validations JJB existantes : le seed ne résout pas la future participation multi-activité. Aucun membre ni essai n’est affecté à ce regroupement. Une confirmation du bureau est nécessaire avant un usage opérationnel réel de ces séances.
...
Bornes conventionnelles de démonstration : 1er septembre 2026 au 31 août 2027. Elles ne constituent pas une confirmation des dates effectives de reprise/fin des cours, ni des vacances ou fermetures. Les créneaux héritent de ces bornes ; aucune exception de calendrier n’est inventée. Aucun seed sur une base déjà peuplée, donc aucune saison historique modifiée.
...
Une définition `image_rights`, version 1, titre Droit à l’image. Le texte est une **formulation courte de démonstration explicitement étiquetée**, pas une transcription ni un texte validé par le bureau. Les décisions existantes granted/refused correspondent à Oui/Non ; withdrawn reste disponible. Aucun accord n’est créé automatiquement et aucune Person réelle n’est importée. Les triggers d’immutabilité, exigences par adhésion et snapshots sont inchangés. La rédaction définitive nécessitera une nouvelle version et la désactivation de la version de démonstration, jamais sa réécriture.

Présentation Organization.description disponible mais laissée absente : pas de prose promotionnelle inventée. Descriptions de groupes utilisées seulement pour l’interprétation métier provisoire. Pas de table de contenu générique, CMS, média, asset Wix, logo téléchargé ou synchronisation. Les enseignants devraient probablement être des Persons reliées fonctionnellement à Activity/Group ; le rôle coach est un droit de User, pas une relation d’enseignement. Aucun domaine instructors ni import de noms de professeurs.
...
Données certaines à cette consultation : identité canonisée, coordonnées publiques, lieu, trois activités, lignes horaires, noms des trois offres. Interprétations : nom court, groupe de pratiques spécifiques, libellés normalisés, bornes conventionnelles de saison, URL construite depuis le compte Instagram, rédaction de démonstration du consentement. Absents : correspondance postale, textes éditoriaux définitifs, assets, enseignants, politiques de quota et documents. Aucun scraper ni requête réseau au démarrage ou à l’exécution du seed.

## Confirmations demandées à l'utilisateur

- Quel est le fonctionnement des séances « Préparation physique / JJB » : succession, simultanéité, groupe commun ou appellation ? Quels publics et quelles modalités d’inscription, notamment le lundi ?
- No-Gi et Libre concernent-ils le groupe adolescents/adultes, des groupes propres ou tous les publics ? Le regroupement technique provisoire doit-il être remplacé ?
- Les limites opérationnelles 7–10 / 10–14 sont-elles de simples indications ou des critères d’éligibilité ? Comment se raccordent-elles à la présentation 7–13 et aux adolescents 14–18 séparés des adultes ?
- Quelles dates effectives de validité et quelles fermetures appliquer aux cours 2026/2027, au-delà des bornes conventionnelles du seed ?
- Quel texte définitif de consentement à l’image le bureau souhaite-t-il présenter et versionner ?

Ces points ne bloquent pas la démonstration ; aucune réponse n’a été sollicitée pendant le développement. Ils ne doivent pas être considérés comme validés par le seed.
...
Réponses démontrées depuis la base seule : club Budokan Sud Oise ; lieu La Mardelle et adresse ; trois activités ; six groupes dont un provisoire documenté ; saison 2026/2027 ; seize créneaux et leur lieu ; trois types d’adhésion et une définition de droit à l’image. La commande ne charge pas config/config.json.
...
Le modèle générique, le jeu versionné et les lectures sont utilisables. Les confirmations restantes concernent l’interprétation sportive et les textes définitifs, pas un échec technique. Pas de contrôle visuel ajouté : aucun handler/template/design public modifié. Aucun engagement de fonctionnement multi-tenant, de quotas d’essais, de tarification calculée ou de site public Budokan final.

## 15. Fichiers créés/modifiés et état Git
...
État Git final (toutes les modifications restent non indexées) :
